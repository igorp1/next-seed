...
// SERVICES
import { pingSlack } from '../../services/_common' // 3. Use services to fetch initial props
        ...
        return (
            <PageContainer>
                ...
                <div style={ {textAlign:'center'} }>
                    <img width="500px" src="https://media.giphy.com/media/1yn1rjD3yhlFCKDJ0v/giphy.gif" />
                </div>
...
export default Admin // 11. Pages must have the default export
